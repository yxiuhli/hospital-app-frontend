    ...
    <div className='w-full h-[calc(100vh-118px)] grid grid-cols-[400px_1fr] grid-rows-[100%]'>
      <div className='bg-[#5CA0D3] pt-3'>
        ...
        <div className="flex justify-between items-center p-2 mx-7 gap-4 shadow-lg rounded-3xl bg-[#D6E5FA]">
          <img src={"/" + (supporter.gender == 'Nam' ? 'doctor_male' : 'doctor_female') + ".png"} alt="" srcSet="" className='object-cover rounded-full w-[25%] aspect-square'/>
          <div className="w-full flex flex-col items-start justify-start gap-3">
            ...
            <Typography className="w-[60%] text-xl"> 
                ...
                <span className='w-max capitalize font-light '>{supporter.job}</span>
            </Typography>
          </div>
        </div>
        <Card className='mx-7 mt-4 gap-5 text-xl shadow-lg rounded-3xl bg-[#D6E5FA]'>
          <List>
            <ListItem disablePadding>
              <ListItemButton>
                <ListItemText>Ngày sinh: {supporter.dob.split('-').reverse().join('-')}</ListItemText>
              </ListItemButton>
            </ListItem>
            <ListItem disablePadding>
              <ListItemButton>
            ...
            <ListItem disablePadding>
              <ListItemButton>
                <ListItemText>Ngày bắt đầu làm: {supporter.startedWork.split('-').reverse().join('-')}</ListItemText>
              </ListItemButton>
            </ListItem>
            <ListItem disablePadding>
              <ListItemButton>
                <ListItemText>Bằng cấp: {supporter.degree}</ListItemText>
              </ListItemButton>
            </ListItem>
          </List>
        </Card>
